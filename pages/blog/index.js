    ...
    <>
      <Layout>
        <div className="blogIndexTitle">
          <h1 className="blogIndex__title"><i className="pi pi-th-large" style={{ 'fontSize': '22px', marginRight: "10px" }} />Blog Posts</h1>
        </div>
      ...
      <style jsx>
        {`
          ...
          .blogIndexTitle::before {
            ...
            background-image: radial-gradient(circle at 10px -15px, transparent 20px, rgb(255, 255, 255) 21px);
          }
          .blogIndexTitle::after {
            content: "";
            position: absolute;
            ...
            background-image: radial-gradient(circle at 10px 26px, rgb(255, 255, 255) 20px, transparent 21px);
          }
        `}
      </style>
    </>
